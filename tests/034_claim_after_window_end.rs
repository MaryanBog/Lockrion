// ==============================
// tests/034_claim_after_window_end.rs
// ==============================
#![forbid(unsafe_code)]
...
#[tokio::test]
async fn claim_after_window_end() {
    ...
    // claim at EXACT end (maturity + claim_window) -> must FAIL
    let claim_window: i64 = 90 * 86_400;
    let target = maturity_ts + claim_window;
    ...
    assert!(res.is_err(), "claim at maturity+claim_window unexpectedly succeeded");
}