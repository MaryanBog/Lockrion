// tests/022_claim_after_claim_window_rejected_pt.rs
#![forbid(unsafe_code)]
...
#[tokio::test]
async fn claim_after_claim_window_rejected_pt() {
    ...
    // deposit to create user state + participation
    ...
    send_expect_custom_err(
        &mut ctx,
        vec![claim_ix],
        LockrionError::ClaimWindowClosed as u32,
    )
    .await;
}