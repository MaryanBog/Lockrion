// ==============================
// tests/032_claim_exact_maturity_boundary.rs
// ==============================
#![forbid(unsafe_code)]
...
#[tokio::test]
async fn claim_exact_maturity_boundary() {
    ...
    // platform_treasury must be a token account (as in 013/031 model)
    ...
    assert!(after > before, "claim at maturity_ts did not increase reward");
}