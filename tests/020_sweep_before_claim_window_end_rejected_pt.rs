// tests/020_sweep_before_claim_window_end_rejected_pt.rs
#![forbid(unsafe_code)]
...
#[tokio::test]
async fn sweep_before_claim_window_end_rejected_pt() {
    ...
    // finalize participation (withdraw to persist weight)
    ...
    // attempt sweep BEFORE claim window end -> must fail
    let sweep_ix = mk_ix(
        program_id,
